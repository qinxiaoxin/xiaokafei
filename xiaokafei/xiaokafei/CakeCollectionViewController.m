//
//  CakeCollectionViewController.m
//  xiaokafei
//
...
@interface CakeCollectionViewController ()

@property (nonatomic, strong) NSArray *array;

@end

@implementation CakeCollectionViewController
...
- (void)viewDidLoad {
    ...
    _array = (NSArray *)((AppDelegate *)[[UIApplication sharedApplication] delegate]).cakeArray;
