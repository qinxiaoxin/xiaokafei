//
//  DrinkCollectionViewController.m
//  xiaokafei
//
...
@interface DrinkCollectionViewController ()

@property (nonatomic, strong) NSArray *array;

@end

@implementation DrinkCollectionViewController
...
- (void)viewDidLoad {
    ...
    _array = (NSArray *)((AppDelegate *)[[UIApplication sharedApplication] delegate]).drinkArray;
