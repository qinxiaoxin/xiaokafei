//
//  MilkIceCollectionViewController.m
//  xiaokafei
//
...
@interface MilkIceCollectionViewController ()

@property (nonatomic, strong) NSArray *array;

@end

@implementation MilkIceCollectionViewController
...
- (void)viewDidLoad {
    ...
    _array = (NSArray *)((AppDelegate *)[[UIApplication sharedApplication] delegate]).milkflakeArray;
